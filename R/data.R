...
#'   \item{Limited_English_Students}{Limited English Students in percent, from 0 to 100, based on the number of students found eligible for bilingual education}
#'   \item{Low_Income_Students}{Low Income Students in percent, from 0 to 100, based on families eligible for free or reduced price lunches or are publicly supported}
#'   \item{Average_Class_Size_Student_per_Teacher}{Calculated as number of students divided by number of teachers on the first day of May}
