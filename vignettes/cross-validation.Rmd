...
Now do the same analysis for the school drop-out data set.  It has more real-valued cues rather than binary cues.  Note that this data set has na's, so we use na.omit to clean them because not all heuristics can handle them properly.
```{r}
...
Franklin model and dawes model do really well at all training set sizes.