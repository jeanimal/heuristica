...
```{r}
model_list <- list(dawesModel, validityWeightModel, ttbModel, logRegModel, regModel)
...
It shows model accuracy decreasing as more random cues are added, which is not a surprise.  In general, regModel, dawesModel, and validityWeightModel are best.  ttbModel does pretty badly.
