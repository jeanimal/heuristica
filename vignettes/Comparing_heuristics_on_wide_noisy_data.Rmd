...
```{r}
model_list <- list(dawesModel, franklinModel, ttbModel, logRegModel, regModel)
...
It shows model accuracy decreasing as more random cues are added, which is not a surprise.  In general, regModel, dawesModel, and franklinModel are best.  ttbModel does pretty badly.
